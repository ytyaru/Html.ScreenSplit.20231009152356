(function () { // window.noveld
    class Noveld {
        #s; #p; #l; #r;
        #defaultOptions = {break:true, thematicBreak:true, thematicBreakBorder:true, thematicBreakText:'◇◆◇◆'}
        constructor() { this.resetOptions(); this.#l = new Lexer(); }
        ...
        parse(src) { return this.#l.lex(src) }
