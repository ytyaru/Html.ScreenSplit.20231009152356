class CenterSplitScreen {
    ...
    /*
    #lineEm() {
        if ((this.#clientInline()/this.options.count) < 640) { return Math.floor(((this.#clientInline()/this.options.count)-(this.#inlinePaddingEm()*16)) / (16 * (1+Css.getFloat('--letter-spacing')))) }
        else { return 40 }
    }
    */
