...
class FitTextBlock {
    ...
    addBlock(block) {
        ...
        */
        ...
        /*
        if (this.logs[this.size][0]) {
            //console.log(this.blocks.slice(this.logs[this.size][0].blockEndIndex))
            console.log(this.logs[this.size][0])
            console.log(this.logs[this.size][0].blockEndIndex)
            console.log(this.blocks.slice(this.logs[this.size][0].blockStartIndex, this.logs[this.size][0].blockEndIndex))
        }
        */
    }
...
class FitParagraph {
    ...
    //init(logs) { this.logs=logs; this.blocks.splice(0); }
